        ...
        <div>
            {
                loaded ? (
                    <Link href={'https://www.youtube.com/' + info.customUrl} rel="noopener noreferrer" target="_blank">
                        <div className={`flex flex-row opacity-0 items-center px-8 w-full border-2 bg-dark-bg rounded-2xl border-neutral-800 py-6 my-4 group/item transition-all duration-300 ease-out ${loaded ? 'opacity-100 border-opacity-100' : 'opacity-0 border-opacity-0'
                            ...
                            <div className="flex flex-col w-full pl-8 font-light">
                                ...
                                <div className="text-sm border-2 border-neutral-800 rounded-2xl pr-2 font-sans h-24 transition-all duration-300 ease-out overflow-hidden hover:overflow-y-auto scrollbar-none w-full p-2 font-light">{info.description}</div>
                            </div>
                        </div>
                    </Link>
                ) : (
