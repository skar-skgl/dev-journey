    ...
    return (
        <div>
            <Link href={info.link} rel="noopener noreferrer" target="_blank">
                <div className="flex flex-row items-center px-8 w-full border-2 bg-dark-bg rounded-2xl border-neutral-800 py-6 my-4 group/item transition-all duration-300 ease-out hover:bg-neutral-900 hover:border-sky-200 hover:border-opacity-25">
                    ...
                    <div className="flex flex-col w-full pl-8 font-light">
                        ...
                        <div className="text-sm border-2 border-neutral-800 rounded-2xl pr-2 font-sans h-24 transition-all duration-300 ease-out overflow-hidden hover:overflow-y-auto scrollbarSmall w-full p-2 font-light">{info.description}</div>
                    </div>
                </div>
            </Link>
        </div >
